      ...
      <div className="max-w-[95%] 2xl:max-w-[90%] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form onSubmit={handleProductSubmit} className="space-y-6">
          ...
          <div className="bg-slate-800/80 backdrop-blur-sm rounded-xl p-5 lg:p-6 shadow-lg shadow-red-600/20 border border-slate-700">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              <div className="md:col-span-2 lg:col-span-3">
                <label className="block text-sm font-semibold text-yellow-300 mb-2 flex items-center gap-1">
                  <span>📦</span> Nombre *
                </label>
                <input
                  type="text"
              ...
              <div className="lg:col-span-2">
                ...
                <div className="border-2 border-yellow-300/30 rounded-lg p-4 bg-slate-800/70 max-h-96 overflow-y-auto space-y-4">
                  {categories.map((category) => {
                    ...
                    return (
                      <div key={category.id} className="border-b border-yellow-300/30 pb-4 last:border-0">
                        {/* Categoría principal */}
                        <label className="flex items-center gap-2 hover:bg-yellow-50 p-2 rounded cursor-pointer font-medium">
                          <input
                            ...
                            className="rounded border-yellow-300/40 text-yellow-500 focus:ring-amber-500 w-4 h-4"
                          />
                              ...
                              return (
                                <label key={sub.id} className="flex items-center gap-2 hover:bg-yellow-50 p-2 rounded cursor-pointer">
                                  <input
                                    ...
                                    className="rounded border-yellow-300/40 text-red-600 focus:ring-orange-500 w-4 h-4"
                                  />
          ...
          <div className="bg-slate-800/80 backdrop-blur-sm rounded-xl p-5 lg:p-6 shadow-lg shadow-red-600/20 border border-slate-700">
            ...
            <div className="mb-4 p-3 bg-slate-800 border border-yellow-300-200 rounded-lg text-sm">
              <p className="text-secondary font-medium mb-2">📐 Especificaciones:</p>
              <ul className="text-yellow-300-hover space-y-1">
            ...
            {/* Image Upload Area */}
            <div className="border-2 border-dashed border-yellow-300-200 rounded-lg p-6 text-center bg-slate-800/50 hover:bg-slate-800 transition-colors">
              <input
                type="file"
                multiple
                accept="image/*"
