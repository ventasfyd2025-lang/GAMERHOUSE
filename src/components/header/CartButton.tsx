...
const CartButton = memo(function CartButton({ totalItems }: CartButtonProps) {
  return (
    ...
    >
      ...
      {totalItems > 0 && (
        <span className="absolute -top-1 -right-1 bg-gradient-to-r from-primary to-primary-hover text-white text-xs font-bold rounded-full h-5 w-5 flex items-center justify-center shadow-lg animate-pulse">
