...
const ProductCard = memo(({ product }: { product: Product }) => {
  ...
  return (
    <div className="bg-slate-900/80 rounded-lg shadow-sm hover:shadow-lg shadow-red-600/15 transition-all duration-200 border border-yellow-300/30 hover:border-yellow-300-400 overflow-hidden h-full flex flex-col">
      {/* Badges */}
      ...
      <div className="bg-slate-900/90 backdrop-blur-sm rounded-xl shadow-xl shadow-red-600/30 p-4 sm:p-6 border border-yellow-300">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          {showViewAll && (
            <Link
              href={viewAllLink}
              className="px-4 py-2 rounded-xl text-white font-semibold transition-all duration-200 hover:scale-105 shadow-lg shadow-red-600/15 text-sm"
