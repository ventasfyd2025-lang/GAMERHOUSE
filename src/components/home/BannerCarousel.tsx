...
const BannerCarousel = memo(({
  ...
  return (
    <div
      className="relative w-full rounded-2xl overflow-hidden shadow-xl shadow-cyan-500/30 cursor-grab active:cursor-grabbing"
              ...
              >
                ...
                <div className="absolute inset-0 flex items-center">
                  <div className="px-4 sm:px-8 lg:px-12 w-full max-w-2xl">
                    {banner.badgeText && (
                      <span
                        className="inline-block px-3 py-1 text-xs font-semibold text-white rounded-full shadow-lg shadow-cyan-500/20 mb-4"
                    ...
                    {(banner.ctaText || banner.ctaLink) && (
                      <div className="mt-6">
                        {banner.ctaLink ? (
                          <Link
                            href={banner.ctaLink}
                            className="inline-flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 rounded-full bg-primary text-white font-semibold shadow-lg shadow-cyan-500/20 hover:bg-primary-hover transition-colors"
                          ...
                          <span className="inline-flex items-center justify-center px-4 sm:px-6 py-2.5 sm:py-3 rounded-full bg-dark/80/20 text-white font-semibold shadow-lg shadow-cyan-500/20">
