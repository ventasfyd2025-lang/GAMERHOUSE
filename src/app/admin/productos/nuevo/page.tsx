    ...
    <div className="min-h-screen bg-gradient-to-br from-dark-light via-dark-light to-dark-light">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-primary/80">Completa la información del producto</p>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="max-w-[95%] 2xl:max-w-[90%] mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <form onSubmit={handleProductSubmit} className="space-y-6">
          ...
          {/* Basic Info Section */}
          <div className="bg-dark/80/90 backdrop-blur-sm rounded-xl p-5 lg:p-6 shadow-lg shadow-primary/20 border border-dark-light">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5">
              <div className="md:col-span-2 lg:col-span-3">
                <label className="block text-sm font-semibold text-primary mb-2 flex items-center gap-1">
                  <span>📦</span> Nombre *
                </label>
                <input
                  type="text"
                  ...
                  required
                  className="w-full px-4 py-3 text-sm border-2 border-primary/30 rounded-lg focus:outline-none transition-all duration-200 bg-dark/80"
              ...
              <div>
                ...
                <input
                  ...
                  required
                  placeholder="SKU-001"
                  className="w-full px-4 py-3 text-sm border-2 border-primary/30 rounded-lg focus:outline-none transition-all duration-200 uppercase bg-dark/80"
                  onFocus={(e) => e.currentTarget.style.borderColor = 'var(--primary)'}
                  onBlur={(e) => e.currentTarget.style.borderColor = '#d1d5db'}
                />
              </div>
          ...
          <div className="bg-dark/80/90 backdrop-blur-sm rounded-xl p-5 lg:p-6 shadow-lg shadow-primary/20 border border-dark-light">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-5">
              <div className="lg:col-span-2">
                <label className="block text-sm font-semibold text-primary mb-3 flex items-center gap-1">
                  <span>📂</span> Categorías y Subcategorías * (selecciona todas las que apliquen)
                </label>
                <div className="border-2 border-primary/30 rounded-lg p-4 bg-dark/80 max-h-96 overflow-y-auto space-y-4">
          ...
          <div className="bg-dark/80/90 backdrop-blur-sm rounded-xl p-5 lg:p-6 shadow-lg shadow-primary/20 border border-dark-light">
            ...
            <textarea
              ...
              rows={4}
              className="w-full px-4 py-3 text-sm border-2 border-primary/30 rounded-lg focus:outline-none transition-all duration-200 resize-none bg-dark/80"
              onFocus={(e) => e.currentTarget.style.borderColor = 'var(--primary)'}
              onBlur={(e) => e.currentTarget.style.borderColor = '#d1d5db'}
          ...
          <div className="bg-dark/80/90 backdrop-blur-sm rounded-xl p-5 lg:p-6 shadow-lg shadow-primary/20 border border-dark-light">
            ...
            <div className="border-2 border-dashed border-primary-200 rounded-lg p-6 text-center bg-dark-light/50 hover:bg-dark-light transition-colors">
              ...
              <label htmlFor="product-images" className="cursor-pointer block">
                <div className="flex flex-col items-center">
                  ...
                  <p className="text-sm font-medium" style={{ color: 'var(--primary)' }}>Agregar imágenes</p>
            ...
            {productImagePreviews.length > 0 && (
              <div className="mt-4">
                <p className="text-sm font-medium text-primary/80 mb-3">✨ Nuevas imágenes a agregar:</p>
                  ...
                  {productImagePreviews.map((preview, index) => (
                    <div key={`new-${index}`} className="relative group">
                      ...
                      <button
                        ...
                        className="absolute -top-2 -right-2 bg-pink text-white rounded-full w-6 h-6 flex items-center justify-center text-sm hover:bg-pink transition-colors"
                      >
                        ✕
                      </button>
          ...
          {/* Bottom Actions */}
          <div className="bg-dark/80/95 backdrop-blur-sm rounded-xl p-5 shadow-lg shadow-primary/20 border border-primary/30 sticky bottom-0 z-10">
            <div className="flex gap-4">
              <Link
                href="/admin"
                className="flex-1 bg-gray-400 hover:bg-dark0 text-white font-semibold py-4 px-6 rounded-xl transition-all duration-200 transform hover:scale-105 shadow-lg shadow-primary/20 hover:shadow-xl shadow-primary/30 flex items-center justify-center gap-2"
              >
              ...
              <button
                ...
                className="flex-[2] text-white font-bold py-4 px-6 rounded-xl transition-all duration-200 transform hover:scale-105 disabled:opacity-50 disabled:transform-none disabled:cursor-not-allowed shadow-lg shadow-primary/20 hover:shadow-xl shadow-primary/30"
                style={{
