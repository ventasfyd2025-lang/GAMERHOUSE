...
const ProductCard = memo(({ product }: { product: Product }) => {
  ...
  return (
    <div className="bg-slate-900/80 rounded-lg shadow-sm hover:shadow-lg shadow-red-600/20 transition-all duration-200 border border-yellow-300/30 hover:border-yellow-300-400 overflow-hidden h-full flex flex-col">
      {/* Badges */}
      ...
      {/* Imagen cuadrada */}
      <div className="relative w-full aspect-square bg-slate-900/80 p-4">
        {product.imagen ? (
      ...
      <div className="p-2 flex flex-col flex-grow">
        ...
        <div className="mt-auto space-y-1.5">
          ...
          <button
            ...
            className="w-full bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white font-bold py-2.5 px-3 rounded-xl transition-all duration-300 text-sm shadow-md hover:shadow-lg shadow-red-600/20 hover:scale-[1.02] active:scale-[0.98] flex items-center justify-center gap-1.5 group"
          >
...
const ProductCarousel = memo(({ 
  ...
  return (
    <section className="space-y-3 sm:space-y-4 lg:space-y-5">
      <div className="bg-slate-900/90 backdrop-blur-sm rounded-xl shadow-xl shadow-red-600/30 p-4 sm:p-6 border border-yellow-300100">
            ...
            {products.map((product) => (
              ...
              >
                <Link
                  ...
                  className="block h-full focus:outline-none focus:ring-2 focus:ring-[var(--primary)] focus:ring-offset-2"
                  onClick={(e) => {
                    if (hasDragged) {
                      e.preventDefault();
                    }
