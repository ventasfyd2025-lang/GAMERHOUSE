...
export default function SalesReportsComponent() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-slate-800 to-white">
      {/* Header Mejorado */}
      <div className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white p-8 rounded-xl shadow-lg shadow-red-600/15 mb-8">
        <div className="flex items-center justify-between">
          ...
          <div className="flex items-center space-x-4">
            ...
            <button
              ...
              className="bg-slate-900/80 text-yellow-400 px-6 py-3 rounded-lg font-semibold hover:bg-slate-800 disabled:opacity-50 disabled:cursor-not-allowed flex items-center shadow-lg shadow-red-600/15 transition-all"
            >
      ...
      {loading && (
        <div className="bg-slate-900/80 rounded-xl shadow-lg shadow-red-600/15 p-8 mb-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
        {dailyReport && (
          <>
            <div className="bg-slate-900/80 rounded-xl shadow-lg shadow-red-600/15 p-6 border-l-4 border-green-500">
            ...
            <div className="bg-slate-900/80 rounded-xl shadow-lg shadow-red-600/15 p-6 border-l-4 border-red-600">
              <div className="flex items-center">
        ...
        {monthlyReport && (
          <div className="bg-slate-900/80 rounded-xl shadow-lg shadow-red-600/15 p-6 border-l-4 border-yellow-300500">
            <div className="flex items-center">
      ...
      <div className="bg-slate-900/80 rounded-xl shadow-lg shadow-red-600/15 p-6 mb-8">
            ...
            {dailyReport.paymentMethods.map((method) => (
              <div key={method.method} className="p-4 bg-green-50 rounded-lg border border-green-200">
                <div className="text-center">
                  <p className="font-semibold text-white text-lg">{method.method}</p>
      ...
      {monthlyReport && (
        <div className="bg-slate-900/80 rounded-xl shadow-lg shadow-red-600/15 p-6">
          <h2 className="text-xl font-semibold mb-6 flex items-center">
