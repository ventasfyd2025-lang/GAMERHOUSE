        ...
        <>
          {shouldRedirectToWhatsApp ? (
            ...
            <a
              ...
              className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-xl shadow-cyan-500/30 transition-all duration-300 hover:scale-110 relative group flex items-center justify-center"
            >
            ...
            <button
              ...
              className="bg-primary-hover hover:bg-primary-hover text-white p-4 rounded-full shadow-xl shadow-cyan-500/30 transition-all duration-300 hover:scale-110 relative group"
            >
