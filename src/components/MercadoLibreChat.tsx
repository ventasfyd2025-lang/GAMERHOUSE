        ...
        <>
          {shouldRedirectToWhatsApp ? (
            ...
            <a
              ...
              className="bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-xl shadow-yellow-400/30 transition-all duration-300 hover:scale-110 relative group flex items-center justify-center"
            >
            ...
            <button
              ...
              className="bg-primary-hover hover:bg-primary-hover text-white p-4 rounded-full shadow-xl shadow-yellow-400/30 transition-all duration-300 hover:scale-110 relative group"
            >
              ...
              <div className="flex-1 overflow-y-auto p-4 space-y-4 bg-dark">
                  ...
                  <div className="text-center py-8">
                    ...
                    <div className="space-y-2 max-w-xs mx-auto">
                      <button
                        ...
                        className="w-full text-left p-3 bg-dark/80 border border-primary/30 rounded-lg hover:bg-dark transition-colors text-sm"
                      >
                        💼 Ayuda con mi pedido
                      </button>
                      <button
                ...
                {typing && (
                  <div className="flex justify-start items-end space-x-2">
                    ...
                    <div className="bg-dark/80 border border-primary/30 rounded-2xl px-4 py-3 shadow-sm">
                      <div className="flex space-x-1">
