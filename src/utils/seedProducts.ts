...
export const testProducts = [
  ...
  },
  {
    ...
    precio: 199990,
    descripcion: 'Monitor LED IPS de 24 pulgadas con resolución Full HD 1920x1080',
  ...
  },
  {
    ...
    precio: 79990,
    descripcion: 'Chaqueta deportiva con material transpirable, perfecta para entrenamientos',
...
export async function seedProducts() {
  try {
    ...
    return { success: false, error: 'Error al agregar productos' };
  }
}