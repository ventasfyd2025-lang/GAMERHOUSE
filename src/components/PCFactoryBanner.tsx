                ...
                <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-4">
                  {slideProducts.map((product) => (
                    <div
                      ...
                      className="bg-dark/80 border border-primary/30 rounded-lg overflow-hidden hover:shadow-lg shadow-primary/20 transition-all duration-300 cursor-pointer group hover:border-primary-300"
                    >
                      {/* Product Image */}
