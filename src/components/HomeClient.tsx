    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-dark-light via-white to-dark-light py-16">
        <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
          <div className="bg-dark/80/90 backdrop-blur-sm rounded-xl shadow-xl shadow-primary/30 p-12 border border-dark-light text-center">
          ...
          {!mainBannerConfig || !mainBannerConfig.active || !mainBannerConfig.slides?.length ? (
            <div className="relative w-full h-[180px] sm:h-[280px] md:h-[350px] lg:h-[450px] xl:h-[500px] bg-gradient-to-br from-primary via-orange-400 to-primary-hover flex items-center justify-center">
              <div className="text-white text-center px-3 sm:px-6 lg:px-8">
                ...
                <p className="text-xs sm:text-sm md:text-base lg:text-xl xl:text-2xl font-medium drop-shadow-xl shadow-primary/30" style={{ textShadow: '1px 1px 3px rgba(0,0,0,0.7)' }}>
          ...
          <div className="max-w-full mx-auto px-4 sm:px-6 lg:px-8">
            <div className="space-y-6">
              <div className="text-center space-y-3">
                <h2 className="text-3xl font-bold text-white text-center bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-6 grid-flow-dense">
                ...
                <Link href="/?category=tecnologia" className="col-span-2 md:col-span-2 md:row-span-2 group">
                  <div className="bg-dark/80 rounded-3xl border border-gray-100 overflow-hidden shadow-lg shadow-primary/20 hover:shadow-2xl transition-all duration-500 hover:-translate-y-2 flex flex-col h-full cursor-pointer">
                    <div className="relative flex-1 min-h-[350px]">
                      ...
                      <span className="absolute top-6 left-6 bg-gradient-to-r from-yellow-500 to-amber-600 text-white text-lg font-bold px-4 py-3 rounded-full shadow-lg shadow-primary/20">
                        HASTA 50% OFF
                      </span>
                ...
                <Link href="/?category=moda" className="col-span-2 sm:col-span-1 md:row-span-2 group">
                  <div className="bg-dark/80 rounded-2xl border border-gray-100 overflow-hidden shadow-md hover:shadow-xl shadow-primary/30 transition-all duration-500 hover:-translate-y-1 flex flex-col h-full cursor-pointer">
                    <div className="relative flex-1 min-h-[300px]">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/70 via-transparent to-transparent"></div>
                      <span className="absolute top-4 left-4 bg-gradient-to-r from-pink-500 to-pink text-white text-sm font-bold px-3 py-2 rounded-full shadow-lg shadow-primary/20">
                        NUEVA COLECCIÓN
                      </span>
                ...
                <Link href="/?category=calzado" className="group">
                  <div className="bg-dark/80 rounded-2xl border border-gray-100 overflow-hidden shadow-md hover:shadow-xl shadow-primary/30 transition-all duration-500 hover:-translate-y-1 flex flex-col h-full cursor-pointer">
                    <div className="relative h-32">
                      <div className="bg-gradient-to-br from-yellow-50 to-dark-light h-full w-full overflow-hidden">
                        <img
