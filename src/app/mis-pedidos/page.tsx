  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-dark-light via-white to-dark-light py-8">
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="bg-dark/80/90 backdrop-blur-sm rounded-xl shadow-xl shadow-cyan-500/30 p-6 border border-dark-light mb-8">
          <div className="flex items-center justify-between">
            ...
            <Link
              href="/"
              className="inline-flex items-center px-6 py-3 rounded-xl text-white font-semibold transition-all duration-200 hover:scale-105 shadow-lg shadow-cyan-500/20 gap-2"
        ...
        {loadingOrders ? (
          ...
          <div className="bg-dark/80/90 backdrop-blur-sm rounded-xl shadow-xl shadow-cyan-500/30 p-12 border border-dark-light text-center">
            ...
            <button
              onClick={() => router.push('/')}
              className="px-8 py-3 rounded-xl text-white font-semibold transition-all duration-200 hover:scale-105 shadow-lg shadow-cyan-500/20"
              style={{ background: 'linear-gradient(to right, var(--primary), var(--primary-hover))' }}
            >
              🛍️ Ir a la Tienda
            </button>
          ...
          <div className="space-y-6">
            {orders.map((order) => {
              ...
              return (
                <div key={order.id} className="bg-dark/80/90 backdrop-blur-sm rounded-xl shadow-xl shadow-cyan-500/30 border border-dark-light overflow-hidden hover:shadow-2xl transition-all">
                  {/* Order Header */}
