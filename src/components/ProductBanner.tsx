            ...
            {safeProducts.map((product) => (
              <div key={product.id} className="w-full flex-shrink-0">
                <div 
                  ...
                  className="bg-slate-900/80 rounded-xl shadow-lg shadow-red-600/15 p-6 mx-2 cursor-pointer hover:shadow-xl shadow-red-600/30 transition-all duration-300 hover:scale-105"
                >
                  <div className="flex flex-col md:flex-row items-center gap-8">
                    ...
                    <div className="md:w-1/2 text-center md:text-left">
                      ...
                      <button
                        ...
                        className="text-white font-bold py-4 px-8 rounded-lg text-lg transition-all duration-200 hover:shadow-lg shadow-red-600/15 hover:scale-105"
        ...
        {safeProducts.length > 1 && (
          <>
            <button
              ...
              className="absolute left-2 top-1/2 transform -translate-y-1/2 bg-slate-900/80 hover:bg-slate-900 text-white p-3 rounded-full shadow-lg shadow-red-600/15 transition-all duration-200 hover:scale-110"
              style={{ zIndex: 10 }}
            >
            ...
            <button
              onClick={goToNext}
              className="absolute right-2 top-1/2 transform -translate-y-1/2 bg-slate-900/80 hover:bg-slate-900 text-white p-3 rounded-full shadow-lg shadow-red-600/15 transition-all duration-200 hover:scale-110"
              style={{ zIndex: 10 }}
            >
