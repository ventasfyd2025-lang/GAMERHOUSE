...
export default function ProductPage() {
  ...
  const handleAddToCart = () => {
    ...
    notification.className = 'fixed top-4 right-4 bg-green-500 text-white px-6 py-3 rounded-md shadow-lg shadow-primary/20 z-50 transition-all duration-300';
                ...
                return images.length > 1 && (
                  <>
                    <button
                      ...
                      className="absolute left-2 top-1/2 -translate-y-1/2 bg-dark/80/80 hover:bg-dark/80 p-2 rounded-full shadow-lg shadow-primary/20 transition-all"
                    >
                    ...
                    <button
                      ...
                      className="absolute right-2 top-1/2 -translate-y-1/2 bg-dark/80/80 hover:bg-dark/80 p-2 rounded-full shadow-lg shadow-primary/20 transition-all"
                    >
                      <svg className="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
