...
const ProductCard = memo(({ product }: { product: Product }) => {
  ...
  return (
    <div className="bg-dark/80 rounded-lg shadow-sm hover:shadow-lg shadow-primary/20 transition-all duration-200 border border-primary/30 hover:border-primary-400 overflow-hidden h-full flex flex-col">
      {/* Badges */}
      ...
      <div className="p-2 flex flex-col flex-grow">
        ...
        <div className="mt-auto space-y-1.5">
          {product.precioOriginal && product.precioOriginal > product.precio && (
            <div className="text-[10px] text-primary/50 line-through">
...
const ProductCarousel = memo(({ 
  ...
  return (
    <section className="space-y-3 sm:space-y-4 lg:space-y-5">
      <div className="bg-dark/80/90 backdrop-blur-sm rounded-xl shadow-xl shadow-primary/30 p-4 sm:p-6 border border-primary100">
        <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
          ...
          {showViewAll && (
            <Link
              href={viewAllLink}
              className="px-4 py-2 rounded-xl text-white font-semibold transition-all duration-200 hover:scale-105 shadow-lg shadow-primary/20 text-sm"
