            ...
            >
              ...
              {(slide.title || slide.subtitle) && (
                <div className="absolute inset-0 bg-gradient-to-t from-black/80 via-black/40 to-transparent flex flex-col items-center justify-center text-white p-4 sm:p-8">
                  ...
                  {slide.subtitle && (
                    <p className="text-sm sm:text-lg md:text-xl lg:text-2xl text-center drop-shadow-lg shadow-yellow-400/20 opacity-95 max-w-3xl animate-fade-in">
                      {slide.subtitle}
                    </p>
                  )}
                  <button className="mt-4 sm:mt-6 bg-dark/80 text-white px-6 sm:px-8 py-2 sm:py-3 rounded-full text-sm sm:text-base font-bold hover:scale-110 hover:shadow-2xl transition-all duration-300 animate-fade-in">
                    Ver Más
                  </button>
                </div>
              )}
