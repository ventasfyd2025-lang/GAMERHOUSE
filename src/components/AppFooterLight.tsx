    ...
    <footer className="bg-white text-gray-900 border-t border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 gap-12 md:grid-cols-4 mb-12">
          ...
          {/* Categories */}
          <div className="space-y-4">
            <h3 className="font-bold uppercase tracking-widest text-sm text-gray-900 border-b border-gray-300 pb-3">📂 Categorías</h3>
            <ul className="space-y-3 text-sm">
              <li>
                <Link href="/categoria/pokemon-tcg" className="text-gray-600 hover:text-gamerhouse-red hover:translate-x-1 transition-all duration-200 inline-flex items-center gap-2">
          ...
          {/* Company */}
          <div className="space-y-4">
            <h3 className="font-bold uppercase tracking-widest text-sm text-gray-900 border-b border-gray-300 pb-3">🏢 Compañía</h3>
            <ul className="space-y-3 text-sm">
              <li>
          ...
          {/* Contact */}
          <div className="space-y-4">
            <h3 className="font-bold uppercase tracking-widest text-sm text-gray-900 border-b border-gray-300 pb-3">📞 Contacto</h3>
            <div className="space-y-4 text-sm">
              <div className="flex items-center gap-3 group">
                <Mail className="h-5 w-5 text-gamerhouse-red flex-shrink-0 group-hover:scale-110 transition-transform" />
                <a href="mailto:contacto@gamerhouse.cl" className="text-gray-600 hover:text-gamerhouse-red transition-colors duration-200">
              ...
              <div className="flex items-center gap-3 group">
                ...
                <a href="tel:+56920265061" className="text-gray-600 hover:text-gamerhouse-red transition-colors duration-200">
                  +56 9 2026 5061
                </a>
              </div>
              <div className="flex items-start gap-3 group">
                <MapPin className="h-5 w-5 text-gamerhouse-red flex-shrink-0 mt-0.5 group-hover:scale-110 transition-transform" />
                <span className="text-gray-600">Santiago Centro & Las Condes, Chile</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="border-t border-gray-300 pt-10">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
            {/* Social Links */}
            <div>
              <h4 className="text-sm font-bold text-gray-900 mb-4 uppercase tracking-widest">Síguenos en Redes</h4>
            ...
            {/* Payment Methods */}
            <div>
              <h4 className="text-sm font-bold text-gray-900 mb-4 uppercase tracking-widest">Métodos de Pago</h4>
              <div className="flex flex-wrap gap-2">
                <span className="px-3 py-1.5 bg-gray-100 text-gray-700 text-xs rounded-lg border border-gray-300">💳 Mercado Pago</span>
