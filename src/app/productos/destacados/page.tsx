      ...
      <main className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 pt-32 pb-16">
        ...
        {featuredProducts.length === 0 ? (
          <div className="text-center py-12">
            ...
            <Link
              href="/"
              className="inline-flex items-center px-6 py-3 bg-yellow-400 text-white font-semibold rounded-lg hover:bg-yellow-400 transition-colors"
            >
            ...
            {featuredProducts.map((product) => (
              <div key={product.id} className="bg-slate-900/80 rounded-lg shadow-md hover:shadow-xl shadow-red-600/30 transition-all duration-300 overflow-hidden group">
                ...
                <div className="p-4 space-y-3">
                  <div className="text-xs text-yellow-300 uppercase tracking-wide font-semibold">
                    {product.categoria}
                  </div>
                  ...
                  <button 
                    ...
                    className="w-full py-3 px-4 bg-yellow-400 hover:bg-yellow-400 disabled:bg-gray-300 disabled:cursor-not-allowed text-white font-semibold rounded-lg transition-all duration-300 flex items-center justify-center gap-2 hover:scale-105"
                  >
                    <span>🛒</span>
