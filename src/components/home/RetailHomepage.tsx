...
export default function RetailHomepage() {
  ...
  const ProductCard = ({ product }: { product: any }) => {
    ...
    return (
      ...
      <div className="relative h-full overflow-hidden rounded-xl border border-yellow-300/50 bg-gradient-to-br from-slate-800/60 to-slate-900/60 backdrop-blur-sm hover:border-red-600/70 transition-all duration-500 hover:shadow-lg hover:shadow-red-600/30 cursor-pointer">
        {/* Image Container */}
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            ...
            <button
              ...
              className={`px-6 py-3 rounded-lg font-bold transition-all duration-300 whitespace-nowrap backdrop-blur-sm border ${
                selectedCategory === 'all'
                  ? 'bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-black border-yellow-300 shadow-lg shadow-red-600/30'
        ...
        <div>
          <div className="mb-6 sm:mb-8">
            ...
            <div className="h-1 w-16 sm:w-24 bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 rounded mt-3"></div>
          </div>
