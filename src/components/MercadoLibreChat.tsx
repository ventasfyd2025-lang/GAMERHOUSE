        ...
        <>
          {shouldRedirectToWhatsApp ? (
            ...
            <button
              ...
              className="bg-primary-hover hover:bg-primary-hover text-white p-4 rounded-full shadow-xl shadow-red-600/30 transition-all duration-300 hover:scale-110 relative group"
            >
